...
from typing import Dict, Tuple, List, Callable, Optional, Any, Iterable, Union, \
                   Set, Generator, TypedDict, Literal, TypeVar
...
def grade_question_tokenized(data: QuestionDataTemp,
                             question_name: str,
...
def grade_question_parameterized(data: QuestionDataTemp,
                                 question_name: str,
...
def set_holistic_feedback(data: QuestionDataTemp,
...
def get_param(data: QuestionDataTemp, param_name: str) -> Any:
    "Get param for param_name in data dictionary"
    return data['params'][param_name]

def set_param(data: QuestionDataTemp, param_name: str, value: Any) -> None:
...
def set_feedback(data: QuestionDataTemp, feedback_field_name: str, feedback_content: str) -> None:
...
def sized_powerset(iterable: Iterable[PowerSetT], min_size: int = 0, max_size: Optional[int] = None) -> Iterable[Tuple[PowerSetT, ...]]:
